...
class Adafruit_NeoPixel_LJE {

 public:

  // Constructor: number of LEDs, pin number, LED type
  Adafruit_NeoPixel_LJE(uint8_t n, uint8_t p=6, uint8_t t=NEO_GRB + NEO_KHZ800);
  ~Adafruit_NeoPixel_LJE();
 ...
 private:
  ...
  uint8_t
    ...
    brightness;
  uint8_t pixels[1 * 7];        // Holds LED color values (3 bytes each)
